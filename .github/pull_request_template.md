...
Link the narrative packet, implementation specification, issue, or pull request this work consumes. Write `None` only for a root coordination change.
...
- [ ] Existing service registrations and unrelated systems are preserved.

## Validation

List exact commands, test suites, editor checks, or manual scenarios and their results.
