...
- Champion Mode's first playable screen is being treated as the premium adult-facing vertical slice: darker arena lighting, stronger layered boss silhouette, pulsing citadel floor strokes, arena banners, braziers, distinctive skill cast/impact VFX, combat-weather flashes, bordered combat HUD panels, cooldown hotbar overlays, a more intentional plated hero silhouette with close-read equipment detail, encounter intro countdown, camera shake/floating combat feedback, hit pause, damage flash, low-health edge feedback, encounter clear/failure feedback, tactical post-failure guidance, detailed customization controls, one-click forge identity presets, and a lit inspection showcase.
