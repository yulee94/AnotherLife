...
Closed issues may be reopened when current source or Unity Hub play shows they still block the product direction. The long-term playable path must launch into realm selection, enter polished 2.5D kingdom mode, progress into 3D realm-vs-realm warzone play, support dragon/boss/gem/Warmaster objectives, and ultimately verify the eight-gem final wish objective.
