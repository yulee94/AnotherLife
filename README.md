...
- Champion arena with movement, combat, auto modes, catalog-driven skill buttons, an atmospheric Obsidian Citadel combat presentation, layered procedural champion and boss models, combat camera feedback, polished combat HUD, boss encounters with live HP/break/enrage state, RvR bot crowds, world objective markers, runtime weather, and modular character customization.
