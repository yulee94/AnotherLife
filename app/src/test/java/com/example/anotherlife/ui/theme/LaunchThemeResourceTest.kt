...
class LaunchThemeResourceTest {
    ...
    fun launchPaletteMatchesTheApprovedLightAndDarkFoundations() {
        ...
        assertEquals(
            "#10130F",
            colorValue("app/src/main/res/values/launch_colors.xml", "launch_navigation_bar")
        )
    }
    ...
    fun launchThemesSelectLegibleDayNightParentsAndReuseTheLauncherIcon() {
        ...
        assertEquals(
            "@color/launch_navigation_bar",
            lightPlatformBase.items["android:navigationBarColor"]
        )
        assertEquals(
            "@color/launch_navigation_bar",
            darkPlatformBase.items["android:navigationBarColor"]
        )
        ...
        assertEquals(
            ...
            lightApi27Base.items["android:navigationBarColor"]
        )
        assertEquals(
            "@color/launch_background",
            darkApi27Base.items["android:navigationBarColor"]
        )
