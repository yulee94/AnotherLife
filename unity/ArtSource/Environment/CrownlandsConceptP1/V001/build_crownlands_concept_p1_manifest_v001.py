...
def main() -> None:
    ...
    manifest = {
        ...
        "authority": {
            ...
            "architectureLanguageOnly": "unity/ArtSource/Environment/World2DProductionGuides/V001/crownlands_architecture_source.png",
        ...
        "identity": {
            ...
            "forbidden": [
                "delicate needle spires",
                "generic cathedral",
                "excessive gold",
                "ungrounded white-marble palace",
                "color-only variants",
                "fake facade shells",
        ...
        "dimensional_control_not_ai_numerals": {
            ...
            "public_hall_opening_m": [2.5, 3.0],
            "street_width_m": 6,
            "keep_visual_intent_m": {"across": 56, "to_walltop": 18},
    ...
    (ROOT / "crownlands_concept_p1_manifest_v001.json").write_text(
