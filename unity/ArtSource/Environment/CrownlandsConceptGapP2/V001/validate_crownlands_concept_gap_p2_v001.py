#!/usr/bin/env python3
"""Fail-closed validation of CrownlandsConceptGapP2 V001 dimensions, hashes, links, and counts."""
...
SHEETS = [
    ("fam_crownlands_sequential_gate_wall_complex", "crownlands_sequential_gate_outer_face_v001"),
    ("fam_crownlands_sequential_gate_wall_complex", "crownlands_sequential_gate_inner_face_v001"),
    ("fam_crownlands_sequential_gate_wall_complex", "crownlands_sequential_gate_longitudinal_section_v001"),
    ("fam_crownlands_sequential_gate_wall_complex", "crownlands_sequential_wall_walltop_modules_v001"),
    ("fam_crownlands_fortress_single_gate", "crownlands_fortress_plan_apron_v001"),
    ("fam_crownlands_fortress_single_gate", "crownlands_fortress_elevations_v001"),
    ("fam_crownlands_fortress_single_gate", "crownlands_fortress_keep_flag_anchor_v001"),
    ("fam_crownlands_terrain", "crownlands_terrain_grades_worldscar_wallend_v001"),
    ("fam_crownlands_terrain", "crownlands_terrain_bridge_abutment_180m_v001"),
    ("fam_crownlands_terrain", "crownlands_terrain_route_bed_v001"),
    ("fam_crownlands_ecosystem_dressing", "crownlands_ecosystem_composition_habitat_v001"),
    ("fam_crownlands_ecosystem_dressing", "crownlands_cave_exterior_language_v001"),
    ("fam_crownlands_material_lod", "crownlands_capital_city_material_kits_v001"),
    ("fam_crownlands_material_lod", "crownlands_lod_material_lighting_reference_v001"),
]
LOCKED_IDS = [
...
def main() -> int:
    errors: list[str] = []
    manifest_path = ROOT / "crownlands_concept_gap_p2_manifest_v001.json"
    ...
    html = DOCS / "Crownlands_Concept_Gap_P2_Packet_V001.html"
    md = DOCS / "Crownlands_Concept_Gap_P2_Packet_V001.md"
    decision = DOCS / "Crownlands_Concept_Gap_P2_Packet_V001_DECISION.md"
    for doc in (html, md, decision):
        ...
        for token in ("Meridian Oathroad", "30 m", "18 m", "180 m"):
            if token not in text:
                fail(errors, f"{doc.name} missing {token}")
    ...
    if html.is_file():
        ...
        for _, stem in SHEETS:
            rel = f"ArtSource/Environment/CrownlandsConceptGapP2/V001/{stem}.png"
