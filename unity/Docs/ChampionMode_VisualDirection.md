...
- Polish the Obsidian Citadel arena with pulsing rune strokes, tactical crosslines, realm-colored start/dais accents, boundary spines, war banners, and braziers so the first view reads as a real combat space instead of a flat prototype floor.
