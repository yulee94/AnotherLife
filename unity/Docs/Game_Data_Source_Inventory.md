...
| Canonical NVS source | `unity/Docs/Narrative/NVS_01/OMEN_1_A1.packet.json` | `schemaVersion: 1`, `omen1-a1-2026-07-22-v002`, `NVS-01`, `OMEN_1` | `ccda655487bd007df7d764a10a186b4683a2bcb7417a0a748740ac24bf183606` | Codex narrative/content source; Editor exporter canonicalizes bytes |
| Derived NVS runtime artifact | `unity/Assets/StreamingAssets/AL/Narrative/OMEN_1.catalog.json` | same logical identity; canonical length 8317 | `b22c166310617657cf9716f988e697d4c4992b4d1877b6fd4d0a3311af9a9a1f` | Strict validator, hash/length/version check, direct-file/UWR byte source, fail-closed loader |

The NVS source and artifact hashes differ because the exporter normalizes the source to canonical minified UTF-8 bytes. The NVS artifact is intentionally under `Assets/StreamingAssets`, while the two legacy shared JSON files are under `Assets/AL/StreamingAssets`; the NVS tests explicitly reject an `Assets/AL/StreamingAssets` duplicate.
...
- Catalog identity: `al.narrative.nvs01`; schema `1`; packet `omen1-a1-2026-07-22-v002`; milestone `NVS-01`; quest `OMEN_1`; speaker `NPC_VALERIUS`.
...
| NVS-01 | `Nvs01CatalogTests` and `Nvs01QuestRuntimeTests` cover canonical bytes/hash/version, strict JSON/schema, references/state graph, immutability, loader result/lifetime, runtime transactions, and adapter outcomes | Still a quest-specific contract, not the common #183 manifest/family catalog |
