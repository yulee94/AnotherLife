...
namespace AL.Tests.EditMode.Architecture
{
    public sealed class CrownlandsStormwrightProductionModelTests
    {
        ...
        public void PackagedCatalogDeclaresExactLiveWorkshopBinding()
        {
            ...
            Assert.That(
                catalog.Entries.Any(candidate =>
                    ...
                    candidate.BuildingId == "Workshop"),
                Is.True,
                "Adding Crownlands must preserve the Eldergrove binding.");
            Assert.That(
                catalog.Entries.Any(candidate =>
                    candidate.RealmId == RealmId.Stonehold &&
                    candidate.BuildingId == "Workshop"),
                Is.True,
                "Adding Crownlands must preserve the Stonehold binding.");
        }
        ...
        public void ProductionPrefabOwnsStableIdentityEnvelopeAndTenDeltas()
        {
            ...
            Assert.That(
                model.SlotEnvelope,
                Is.EqualTo(new Vector3(10f, 7.8f, 8f)));
            Assert.That(
                model.MaximumArtBounds,
                Is.EqualTo(new Vector3(9.65f, 7.55f, 7.2f)));
        ...
        [TestCase(1, 6.55f, 5.17f, 5.00f, 6.60f, 5.25f, 5.10f)]
        [TestCase(6, 8.03f, 6.34f, 6.57f, 8.15f, 6.45f, 6.65f)]
        [TestCase(10, 9.62f, 7.50f, 6.57f, 9.65f, 7.55f, 6.65f)]
        ...
        public void LodTopologyMeetsFinalTriangleAndRendererBudgets()
        {
            ...
            int[] expectedTriangles = { 2400, 1420, 828, 316 };
        ...
        public void PrefabHasOnlyTheTwoApprovedRootBoxColliders()
        {
            ...
            AssertBox(
                ...
                true,
                new Vector3(0f, 3.78f, 0f),
                new Vector3(9.8f, 7.56f, 7.4f));
            AssertBox(
                model.NavigationCollider,
                false,
                new Vector3(0f, 0.75f, 0f),
                new Vector3(9.4f, 1.5f, 6.8f));
        }

        [Test]
        public void LevelTenMeridianCrownLanternOwnsStructureAndContainedIndigoAperture()
        {
            GameObject prefab = LoadPrefab();
            ...
            Assert.That(mesh.bounds.max.y, Is.EqualTo(7.50f).Within(0.02f));
        }
        ...
        public void ProductionPrefabRemainsStaticAndSourceIndependent()
        {
            ...
            Assert.That(
                prefab.GetComponentsInChildren<
                    CrownlandsStormwrightStableActivity>(true),
                Is.Empty);
            Assert.That(
        ...
        public void MismatchedStableModelIdentityFailsVisibly()
        {
            ...
            try
            {
                invalidCatalog.Configure(
                    ...
                    {
                        new KingdomBuildingModelEntry(
                            "building.crownlands.workshop.wrong",
                            RealmId.Crownlands,
                            "Workshop",
                            LoadPrefab(),
                            0.12f,
