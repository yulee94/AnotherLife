    ...
    public sealed class UmbralVeilwrightProductionModelTests
    {
        ...
        public void PackagedCatalogDeclaresExactLiveWorkshopBinding()
        {
            ...
            Assert.That(
                catalog.Entries.Any(candidate =>
                    ...
                    candidate.BuildingId == "Workshop"),
                Is.True,
                "Adding Umbral must preserve the Eldergrove binding.");
            Assert.That(
                catalog.Entries.Any(candidate =>
                    candidate.RealmId == RealmId.Stonehold &&
                    candidate.BuildingId == "Workshop"),
                Is.True,
                "Adding Umbral must preserve the Stonehold binding.");
            Assert.That(
                catalog.Entries.Any(candidate =>
                    candidate.RealmId == RealmId.Crownlands &&
                    candidate.BuildingId == "Workshop"),
                Is.True,
                "Adding Umbral must preserve the Crownlands binding.");
        }
        ...
        public void ProductionPrefabOwnsStableIdentityEnvelopeAndTenDeltas()
        {
            ...
            Assert.That(
                ...
                Is.EqualTo(new Vector3(9.55f, 7.45f, 7.25f)));
        ...
        [TestCase(1, 6.15f, 5.25f, 5.25f, 6.20f, 5.30f, 5.30f)]
        [TestCase(6, 7.84f, 6.17f, 6.46f, 7.90f, 6.25f, 6.55f)]
        [TestCase(10, 8.84f, 7.17f, 6.98f, 8.90f, 7.25f, 7.05f)]
        ...
        public void LodTopologyMeetsFinalTriangleAndRendererBudgets()
        {
            ...
            int[] expectedTriangles = { 1476, 816, 396, 180 };
        ...
        [Test]
        public void LevelTenBoundEclipseYokeOwnsStructureAndContainedVioletSeal()
        {
            GameObject prefab = LoadPrefab();
            ...
            Assert.That(mesh.bounds.max.y, Is.EqualTo(7.17f).Within(0.02f));
        }
        ...
        public void ProductionPrefabRemainsStaticAndSourceIndependent()
        {
            ...
            Assert.That(
                prefab.GetComponentsInChildren<
                    UmbralVeilwrightStableActivity>(true),
                Is.Empty);
            Assert.That(
        ...
        public void MismatchedStableModelIdentityFailsVisibly()
        {
            ...
            try
            {
                invalidCatalog.Configure(
                    ...
                    {
                        new KingdomBuildingModelEntry(
                            "building.umbral.workshop.wrong",
                            RealmId.Umbral,
                            "Workshop",
                            LoadPrefab(),
                            0.12f,
