...
{
    public sealed class EldergroveTownHallProductionModelTests
    {
        private const string PrefabPath =
            "Assets/AL/Art/Generated/Architecture/Eldergrove/Production/" +
            "TownHall/Runtime/Eldergrove_TownHall_Production.prefab";
        private const string CatalogPath =
            "Assets/AL/ScriptableObjects/Resources/" +
            "KingdomBuildingModelCatalog.asset";
        private const string AtlasPath =
            "Assets/AL/Art/Generated/Architecture/Eldergrove/Production/" +
            "TownHall/Runtime/T_Eldergrove_TownHall_Atlas_1024.png";
        private const string AtlasMaterialPath =
            "Assets/AL/Art/Generated/Architecture/Eldergrove/Production/" +
            "TownHall/Runtime/MAT_Eldergrove_TownHall_Atlas.mat";
        private const string AccentMaterialPath =
            "Assets/AL/Art/Generated/Architecture/Eldergrove/Production/" +
            "TownHall/Runtime/MAT_Eldergrove_TownHall_Accent.mat";
        ...
        [TestCase(1, 9.30f, 5.62f, 8.78f)]
        [TestCase(6, 12.42f, 5.70f, 8.95f)]
        [TestCase(10, 12.42f, 7.96f, 10.51f)]
        ...
        public void LodTopologyMeetsFinalTriangleAndRendererBudgets()
        {
            ...
            int[] expectedTriangles = { 3276, 2432, 1452, 800 };
        ...
        public void PrefabHasOnlyTheTwoApprovedRootBoxColliders()
        {
            ...
            AssertBox(
                ...
                true,
                new Vector3(0f, 5.65f, -0.05f),
                new Vector3(14f, 11.3f, 12.8f));
            AssertBox(
                model.NavigationCollider,
                false,
                new Vector3(0f, 0.8f, -0.05f),
                new Vector3(12.7f, 1.6f, 10.7f));
        }

        [Test]
        public void LevelTenOpenCrownArborKeepsItsOculusEmpty()
        {
            GameObject prefab = LoadPrefab();
            ...
            Assert.That(mesh.bounds.max.y, Is.EqualTo(7.95f).Within(0.02f));
            Vector3[] crownVertices = mesh.vertices
                .Where(vertex => vertex.y >= 7.65f)
                .ToArray();
            Assert.That(crownVertices, Is.Not.Empty);
            Assert.That(
                crownVertices.All(vertex =>
                    new Vector2(vertex.x, vertex.z).magnitude > 1.45f),
                Is.True,
                "The supported Level 10 crown must remain open to sky.");
        }
        ...
        [Test]
        public void AdjacentConfirmedTownHallLevelUsesEldergroveMotionOnce()
        {
            var engineObject =
                new GameObject("EldergroveTownHallTransition.Engine");
            try
            {
                var engine =
                    engineObject.AddComponent<CityLayoutEngine>();
        ...
        public void MismatchedStableModelIdentityFailsVisibly()
        {
            ...
            try
            {
                invalidCatalog.Configure(
                    ...
                    {
                        new KingdomBuildingModelEntry(
                            "building.eldergrove.townhall.wrong",
                            RealmId.Eldergrove,
                            "TownHall",
                            LoadPrefab(),
                            0.09f,
