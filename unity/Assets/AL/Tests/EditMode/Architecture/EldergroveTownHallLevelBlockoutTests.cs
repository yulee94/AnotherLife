...
{
    public sealed class EldergroveTownHallLevelBlockoutTests
    {
        ...
        public void StableSpatialIdentityDoesNotMoveWithLevel(string prefabPath)
        {
            ...
            Assert.That(
                ...
                Is.EqualTo(new Vector3(0f, 3.65f, 0f)));
        ...
        public void ReviewAnchorsGrowMonotonicallyWithinGrayboxCeiling()
        {
            ...
            Assert.That(
                ...
                "Eldergrove Town Hall anchors exceed the static review ceiling.");
        }
        ...
        public void LevelOneRoofRisesFromEavesToRidge()
        {
            ...
            Transform west = prefab.transform.Find(
                "L01_OperationalHall/CouncilCanopy_Occlusion/" +
                "CouncilCanopyWestGroup/CouncilCanopyWest");
            Transform east = prefab.transform.Find(
                "L01_OperationalHall/CouncilCanopy_Occlusion/" +
                "CouncilCanopyEastGroup/CouncilCanopyEast");
        ...
        [TestCase(Level06PrefabPath)]
        [TestCase(Level10PrefabPath)]
        public void ExactlyThreePrimaryRootArchesRemainCountable(
            string prefabPath)
        {
            GameObject prefab =
                AssetDatabase.LoadAssetAtPath<GameObject>(prefabPath);
            Transform rootArches = prefab.transform.Find(
                "L01_OperationalHall/StructuralRootArches");
            Assert.That(rootArches, Is.Not.Null);
            Assert.That(rootArches.childCount, Is.EqualTo(3));
            Assert.That(
                rootArches.Cast<Transform>()
        ...
        [Test]
        public void OpenCrownArborIsSupportedStaticAndEmpty()
        {
            GameObject prefab =
                AssetDatabase.LoadAssetAtPath<GameObject>(Level10PrefabPath);
            Transform supports = prefab.transform.Find(
                "L10_OpenCrownArbor/CrownRootSupports");
            Transform oculus = prefab.transform.Find(
                "L10_OpenCrownArbor/OpenSkyOculus");
            Assert.That(supports, Is.Not.Null);
            Assert.That(oculus, Is.Not.Null);
            Assert.That(supports.childCount, Is.EqualTo(3));
            Assert.That(
                oculus.Cast<Transform>()
                    .Count(child =>
