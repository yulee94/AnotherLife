    ...
    public sealed class ProductionPlayerLaunchSmokeTests
    {
        ...
        public void SameDeveloperLocalLowFailsIsolationGate()
        {
            object isolation = Isolation(
                ...
                persistentData: @"C:\Users\Developer\AppData\LocalLow\DefaultCompany\AnotherLifeUnity");
            object result = Evaluate(ValidLog(), Process(), isolation);
            AssertResult(result, "Failed", "IsolationEvidenceInvalid");
        }
        ...
        {
            object isolation = Isolation(persistentData: @"D:\Unproven\AnotherLifeUnity");
            object result = Evaluate(ValidLog(), Process(), isolation);
            AssertResult(result, "Failed", "IsolationEvidenceInvalid");
        }
        ...
        public void PersistentDataDescendantOrDifferentPlayerIdentityFailsIsolationGate()
        {
            AssertResult(
                Evaluate(
                    ValidLog(),
                    Process(),
                    Isolation(persistentData: @"C:\Users\Smoke\AppData\LocalLow\DefaultCompany\AnotherLifeUnity\Nested")),
                "Failed",
            ...
            AssertResult(
                Evaluate(
                    ValidLog(),
                    Process(),
                    Isolation(persistentData: @"C:\Users\Smoke\AppData\LocalLow\OtherCompany\AnotherLifeUnity")),
                "Failed",
                "IsolationEvidenceInvalid");
        }
        ...
        public void DeveloperLocalLowPathInPlayerLogFailsEvenWithIsolationEvidence()
        {
            string log = Join(
                StaticString("ExpectedBootMarkerLine"),
                @"Unexpected read C:\Users\Developer\AppData\LocalLow\DefaultCompany\AnotherLifeUnity\save.json");
            object result = Evaluate(log, Process(), ValidIsolation());
        ...
        private static object Isolation(
            ...
            string developerLocalLow = @"C:\Users\Developer\AppData\LocalLow",
            string launchLocalLow = @"C:\Users\Smoke\AppData\LocalLow",
            string persistentData = @"C:\Users\Smoke\AppData\LocalLow\DefaultCompany\AnotherLifeUnity",
